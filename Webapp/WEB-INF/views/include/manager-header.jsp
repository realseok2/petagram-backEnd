      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-10 title_fnt "style="color:black;">
            <h1 class="display-3"><b>${sMap.shopVo.shopTitle }</b></h1>
            
             <!-- 타이틀 메뉴 -->
            <div class="mt-4">
              <a class="btn btn-secondary store-reservation" href="${pageContext.request.contextPath}/store/${session.shopDomain }/store-reservation" role="button">예약관리 &raquo;</a>
              <a class="btn btn-secondary store-infoModify" href="${pageContext.request.contextPath}/store/${session.shopDomain }/store-infoModify" role="button">정보수정 &raquo;</a>
              <!-- 토글 스위치 -->
...
<script>
	...
	function addClassToNav() {
		...
		var lastURI = uri.split("/").pop();
		var target = $("a."+lastURI);
